...
public class Principal {
    ...
    private static void cadastrarRestaurante() {
        ...
        // Validar se já existe restaurante com mesmo CNPJ
    ...
    private static void cadastrarPrato() {
        ...
        Prato novoPrato = new Prato(nome, preco, descricao, tempoEstimadoEntrega);
    ...
    private static void fazerPedido() {
        ...
        ArrayList<Prato> pratos = restauranteEscolhido.getPratos();
        ...
        Prato pratoEscolhido = pratos.get(escolhaPrato - 1);
    ...
    private static void verRestaurantes() {
        ...
        for (Restaurantes restaurante : restaurantes) {
            ...
            ArrayList<Prato> pratos = restaurante.getPratos();
            if (pratos.isEmpty()) {
